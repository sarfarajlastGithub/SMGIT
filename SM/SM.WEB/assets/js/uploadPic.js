$(function () {
    ...
    $('#file').change(function () {
        ...
        var imgpath = "/Uploads/StudentsProfileImg/";
        ...
        if ((file1 = this.files[0])) {
            ...
            img.onload = function () {
                ...
                if (this.width > 160 && this.height > 240 && typeof ($("#file")[0].files) == "undefined") {
                    cSize = false;
                    $("#lodingFile").addClass("display-none");
                    $("#profileImgId").addClass("display-none");
                    alert("Image has to be Width:140-160 and Height:180-240 <br /> less the 1 mb");
                    return false;
                }
                else {
                    //Else Pic will save
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response != null || response != '') {
                                ...
                                $("#PhotoLocation").val(imgName);
                                $("#lodingFile").addClass("display-none");
                                $("#profileImgId").removeClass("display-none");
                                $('#proimg').attr('src', imgpath + imgName.filenameExt());
                                imgName = "";
                            }
